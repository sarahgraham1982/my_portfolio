...
const Projects = () => {
  ...
  <div className="Projects">
      ...
      <h3><strong>GOLDEN SHOE</strong></h3>
        <h4>Followed a detailed brief for an existing online shoe shop. I created a beautiful, responsive app with a minimalist, classic design and updated product photography.</h4>
        <div className="videowrapper">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/8EEuYIg9o20" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      
        <p>A solo JavaScript project, completed in 7 days, utilizing React, HTML and CSS.</p>
        <p>Due to my background in E-commerce and design, I new instantly how to make an impactful difference to this shoe brand.</p> 
      
      <p><a href="https://github.com/sarahgraham1982/golden_shoe">View the repo on GitHub</a></p>
      <hr></hr>
      ...
      <h4>A mobile app for incentivising volunteers with tangible discounts and rewards. During the pandemic, charities saw a decrease in volunteers, charity shops were closed and there was an increase in the need for charities such as Womens Aid and Domestic Abuse charities. We created a brand new concept in volunteering apps that does not currently exist with the goal of increasing volunteer numbers.</h4>
        <div className="videowrapper">
