  ...
  return (
    <>
      <div className="About">
        ...
        <p>
          Before I qualified as a Software Developer, I ran my own successful online store called <a href="https://www.fangrrrl.com/">Fan Grrrl</a> for over a decade. Using my graphic design skills, I created all the pop culture inspired products and performed every aspect of shop management myself. Having used most of the popular E-commerce platforms over the years, I felt the next logical step in my career was to learn how to create websites from scratch, instead of relying on pre-made templates that often were limited in terms of functionality. After extensive research, I found <a href="https://codeclan.com/">CodeClan</a> and completed their 20 week intensive <a href="https://codeclan.com/courses/professional-software-development/">Professional Software Development</a> course. It was a huge challenge and I enjoyed it immensely. I believe that I am now in the unique position of having both coding and design skills.
        </p>
        <p>
